package com.example.edenungar.callbacksworkshop;
...
public class CallbackFragment extends Fragment {
    ...
    //every time you open the fragment you need a new instance
    ...
    //allows the Callback class to be used or "called" from classes that implement it (like MainActivity)
